            ...
            <Main>
                <Row jc='center'>
                    <AboutDiv>
                            ...
                            <Text size='1.2rem'>
                                Last summer, I went to New York City and joined <HyperLink href="https://www.mongodb.com/" target="_blank">MongoDB</HyperLink> as a 2022 Software Engineer Intern 💻!
                            </Text>
                    </AboutDiv>
                ...
                <Row jc='space-around'>
                    <AboutDiv mw='50rem'>
                        ...
                        <Text size='1.2rem'>
                            <b>Languages:</b> Python, C++, Java, JavaScript, C, SQL, OCaml
                        </Text>
                        <Text size='1.2rem'>
                            <b>Frameworks:</b> Django, Flask, React, Express, Next, Numpy, Pandas, Redux
                        </Text>
                        <Text size='1.2rem'>
                            <b>Software Services:</b> AWS (EC2, S3, ECS, ECR, RDS), Git, Postman, MongoDB, Docker, Kubernetes, Helm, Jira, Amazon MTurk, Figma
                        </Text>
                    </AboutDiv>
